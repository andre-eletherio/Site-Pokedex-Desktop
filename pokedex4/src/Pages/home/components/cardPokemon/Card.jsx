...
export function Card(props) {
  ...
  return (
    <CardStyle style={{ backgroundColor: cardColor }} >
      ...
      <Right>
        {/* <button className={props.pokemon.captured ? "excluir" : "capturar"} onClick={(() => addPokemon(props.pokemon))}>{props.pokemon.captured ? "Excluir" : "Capturar!"}</button> */}
        <button className={props.class} onClick={(() => props.onClickPokemon(props.pokemon))}>{props.text}</button>
        <Back src={back} alt="" />
